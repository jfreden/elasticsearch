...
public class SecurityIndexFieldNameTranslator {
    ...
    public static FieldName prefix(String name, Function<String, String> translation, Predicate<String> validIndexName) {
        return new SecurityIndexFieldNameTranslator.PrefixFieldName(name, translation, validIndexName);
    }
    ...
    private static class PrefixFieldName extends FieldName {
        ...
        private PrefixFieldName(String prefix, Function<String, String> toIndexFieldName, Predicate<String> validIndexNamePredicate) {
            super(toIndexFieldName, validIndexNamePredicate);
            this.prefix = prefix;
        }

        @Override
        public boolean supportsQueryName(String fieldName) {
            return fieldName.startsWith(prefix);
        }

        @Override
        public boolean supportsIndexName(String fieldName) {
            return validIndexNamePredicate.test(prefix);
        }
    }
